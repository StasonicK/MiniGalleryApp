    ...
    public class GridLayoutAdvanced : LayoutGroup, ILayoutSelfController
    {
        ...
        void ReplaceCellsHorizontal()
        {
            ...
            void CalculateBasics()
            {
                ...
                referenceRectSize = rectTransform.rect.height - padding.vertical -
                                    fixedSpacing * (fixedCellsPerLine - 1);
            ...
            float GetHeightShiftAtLastLine()
            {
                ...
                float EmptySpace = referenceRectSize * (EmptyCells / (float)fixedCellsPerLine) +
                                   fixedSpacing * EmptyCells;
        ...
        void ReplaceCellsVertical()
        {
            ...
            {
                linesCount = Mathf.CeilToInt(rectChildren.Count / (float)fixedCellsPerLine);
                referenceRectSize = rectTransform.rect.width - padding.horizontal -
                                    fixedSpacing * (fixedCellsPerLine - 1);
            ...
            void ChangeAndRegisterMySize()
            {
                requestedRectSize = linesCount * cellSize.y + fixedSpacing * (linesCount - 1) + padding.top +
                                    padding.bottom;
