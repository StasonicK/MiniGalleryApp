...
//                 grid.spacing = new Vector2(spacePerCell,
//                     ratioMode == RatioMode.Free ? grid.spacing.y : spacePerCell * cellRatio);
//             }
//             else //if (expand == Axis.Y)
//             {
...
//                 grid.spacing = new Vector2(ratioMode == RatioMode.Free ? grid.spacing.x : spacePerCell * cellRatio,
//                     spacePerCell);
//             }
//         }
//     }
